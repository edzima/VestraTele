...
return [
	...
	[
		'templateId' => 2,
		'subject' => 'Sms About Create Issue(TYPE_2) for Customer.',
		'body' => 'New Issue. Your Agent: {agentName} - {agentPhone}',
		'language' => 'en-US',
	],
	[
		'templateId' => 3,
		'subject' => 'Email. New Issue(TYPE_1 and TYPE_2) for Customer.',
		'body' => 'New Issue. Your Agent: {agentName} - {agentPhone}',
		'language' => 'en-US',
	],
	[
	...
	[
		'templateId' => 6,
		'subject' => 'Email. New Settlement (Administrative) {issue} (All types) for Worker.',
		'body' => 'New Issue. Customer: {customerName} - {customerPhone} Settlement Value: {settlementValue}. Details: {settlementLink}',
		'language' => 'en-US',
	],
];
