...
class RbacController extends Controller {
	...
	public array $permissions = [
		...
		Worker::PERMISSION_WORKERS_WITHOUT_ISSUES,
		...
		Worker::PERMISSION_ISSUE_TYPE_PERMISSIONS,
		Worker::PERMISSION_ISSUE_FILE_UPLOAD => [
			Worker::ROLE_ISSUE_FILE_MANAGER,
		],
		Worker::PERMISSION_FILE_TYPE,
		...
		Worker::PERMISSION_MESSAGE_EMAIL_ISSUE_UPLOAD_FILE,
		...
		SpiModule::PERMISSION_SPI_LAWSUIT_DETAIL,
		SpiModule::PERMISSION_SPI_USER_AUTH,
	];
