...
class CalendarController extends Controller
{
    ...
    public function actionAgent($id)
    {
        ...
        if (Yii::$app->user->identity->id != $id && !Yii::$app->user->can("agent")) throw new NotFoundHttpException('Brak uprawnień ;)');
    ...
    public function actionView($id)
    {
        ...
        if (!Yii::$app->user->can('telemarketer')) throw new NotFoundHttpException('Brak uprawnień ;)');
        $model = new Task();
        $model->agent_id = $id;
